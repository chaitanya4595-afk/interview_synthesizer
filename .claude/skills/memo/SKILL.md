---
name: memo
description: Writes a one page memo for a partner from work/themes.md. Use after the themes skill has run.
---

# Write the partner memo

## Input
Read work/themes.md and CLAUDE.md only.

## Output
Write output/memo.md, 400 words at most:

# Northfield Markets: Should we double private label?
**Answer:** <2 sentences. Answer the case question directly, including what would have to be true.>
...
## Rules
* Every action title is a full sentence a partner could repeat in a meeting. "Pricing" is a label, not an action title.
